...
import { Box, Heading, Link, Grid } from "@theme-ui/components"
...
const PodcastPage = () => (
  <Layout>
    ...
    >
      ...
      >
        <Box sx={{ px: [3, 4], h4: { marginTop: 4, marginBottom: 2 } }}>
          ...
          <p>
            ...
            the management of the booncon oy. The use of the Internet pages of
            the booncon oy is possible without any indication of personal data;
          ...
          <p>
            ...
            applicable to the booncon oy. By means of this data protection
          ...
          <p>
            As the controller, the booncon oy has implemented numerous technical
          ...
          <h4>1. Definitions</h4>
          <p>
            The data protection declaration of the booncon oy is based on the
          ...
          <p>booncon oy</p>
          <p>Suvilahdenkatu 4 B 42</p>
          <p>00500 Helsinki</p>
          <p>Finland</p>
          <p>Phone: +358458980609</p>
          <p>Email: hello@booncon.com</p>
          <p>Website: https://booncon.com</p>
          <h4>3. Cookies</h4>
          <p>
            The Internet pages of the booncon oy use cookies. Cookies are text
          ...
          <p>
            Through the use of cookies, the booncon oy can provide the users of
          ...
          <p>
            The website of the booncon oy collects a series of general data and
          ...
          <p>
            When using these general data and information, the booncon oy does
            ...
            prosecution in case of a cyber-attack. Therefore, the booncon oy
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                ...
                booncon oy, he or she may, at any time, contact any employee of
                the controller. An employee of booncon oy shall promptly ensure
              ...
              <p>
                ...
                employees of the booncon oy will arrange the necessary measures
                in individual cases.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                personal data stored by the booncon oy, he or she may at any
                time contact any employee of the controller. The employee of the
                booncon oy will arrange the restriction of the processing.{" "}
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                subject may at any time contact any employee of the booncon oy.
              </p>
            </li>
            <li>
              ...
              <p>
                The booncon oy shall no longer process the personal data in the
              ...
              <p>
                If the booncon oy processes personal data for direct marketing
                ...
                to the booncon oy to the processing for direct marketing
                purposes, the booncon oy will no longer process the personal
              ...
              <p>
                ...
                personal data concerning him or her by the booncon oy for
              ...
              <p>
                ...
                contact any employee of the booncon oy. In addition, the data
            ...
            <li>
              ...
              <p>
                ...
                consent, the booncon oy shall implement suitable measures to
                safeguard the data subject’s rights and freedoms and legitimate
              ...
              <p>
                ...
                time, contact any employee of the booncon oy.
              </p>
            </li>
            <li>
          ...
          <p>
            ...
            Generator of the{" "}
            <Link href="https://dg-datenschutz.de/?lang=en">
              German Association for Data Protection
            </Link>{" "}
            that was developed in cooperation with{" "}
            <Link href="https://www.wbs-law.de/eng/practice-areas/internet-law/it-law/">
              Privacy Lawyers
            </Link>{" "}
